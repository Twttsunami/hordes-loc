export default [
  {
    ...
    description: {
      ...
      bg: 'Малка кесия, използвана от съпруги на търговци.',
      cs: 'Malá malá peněženka, kterou používají ženy obchodníků.',
...

  {
    ...
    description: {
      ...
      cs: 'Spona stojí za to víc než zbytek.',
...

  {
    ...
    description: {
      ...
      cs: 'Pěkný fialový batoh pro všechny vaše potřeby cestování.',
